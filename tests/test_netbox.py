...
# Netbox context config.
netbox_context_config_data = yaml.safe_load(netbox_config_context)
...
netbox_output_config_context = netbox_api_output["results"]
...
netbox_inventory_config_context = netbox.NetboxAsInventory(Args, netbox_context_config_data)
